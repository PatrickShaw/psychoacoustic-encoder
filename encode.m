...
function [n_y, total_components, total_windows, total_components_removed] = psychoacoustic_encoding(o_y, n_y, o_fs, window_overlap_count, window_time_width, octave_analysis_range, softer_factor_threshold, octave_distance_weighting, read_path, write_path)
